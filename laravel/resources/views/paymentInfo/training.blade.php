            ...
            <div class="col-md-7 ">
                <div id="accordion">
                            ...
                            <div class="card">
                                ...
                                <h5 class="mb-0">
                                  <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <div class="custom-control custom-radio yellow">
                                      ...
                                      <label class="custom-control-label" for="customRadio1" style="color:#5e5e5e;font-size:14px;">Pay in Installments</label>
                                    </div>
                                  </button>
                                </h5>
                              </div>
                              ...
                              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio yellow ml-3">
                                    <input type="radio" id="btn_installment{{ $training_plan->id}}" name="btn_amount" value="{{ $training_plan->training_plan_details->first()->id }}" class="installment custom-control-input">
                                        <label class="custom-control-label mb-3" for="btn_installment{{ $training_plan->id }}" style="color:#5e5e5e;font-size:14px;">
                                            @foreach( $training_plan->training_plan_details as $plan )
                                              Pay {{ $plan->installment_amount }} installment
                                            @endforeach
                                        </label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="card">
                              <div class="card-header" id="headingThree">
                                <h5 class="mb-0">
                                  @if( $total_training_plan->count() > 0 )  
                                  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <div class="custom-control custom-radio yellow">
                                      <input type="radio" id="btn_total" name="btn_amount" value="{{ $total_training_plan->first()->training_plan_details->first()->id }}" class="custom-control-input installment">
                                      <label class="custom-control-label" for="btn_total" style="color:#5e5e5e;font-size:14px;">Pay total fee ({{ $total_training_plan->first()->training_plan_details->first()->installment_amount }})</label>
                                    </div>
                                  </button>
                                  @endif
                ...
                <div style="height: 30px;"></div>
                            <div class="panel panel-default bootstrap-basic">
                                           ...
                                           <div class="container">
                                                <form method="post" id="payment-form" action="{{ route('training_payment.process') }}">
                                                    @csrf
                                                    <section>
                                                        <!-- 
                                                        <label for="amount">
                                                    ...
                                                    <input id="plan_detail_id" name="payment_plan_detail_id" value="" type="hidden" />
                          ...
                          <div class="card bg-white col-7 mt-3">
                                <div class="card bg-white col-12 mt-3">
                                                ...
                                                <form method="post" id="payment-form" action="{{ route('training_payment.coingateProcess') }}">
                                                    @csrf
                                                    <input id="btp_plan_detail_id" name="payment_plan_detail_id" value="" type="hidden" />
