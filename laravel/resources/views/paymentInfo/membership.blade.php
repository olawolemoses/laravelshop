     ...
     <div style="height: 20px;"></div>
                ...
                <div style="height: 30px;"></div>
                            <div class="panel panel-default bootstrap-basic">
                                           ...
                                           <div class="container">
                                                <form method="post" id="payment-form" action="{{ route('membership_payment.process') }}">
                                                    @csrf
                                                    <section>
                                                        <!-- 
                                                        <label for="amount">
                                                    ...
                                                    <input id="membership_id" name="membership_id" value="{{ $membership->id }}" type="hidden" />
                          ...
                          <div class="card bg-white col-7 mt-3">
                                <div class="card bg-white col-12 mt-3">
                                                ...
                                                <form method="post" id="payment-form" action="{{ route('membership_payment.coingateProcess') }}">
                                                    @csrf
                                                    <input id="btp_membership_id" name="membership_id" value="{{ $membership->id }}" type="hidden" />
