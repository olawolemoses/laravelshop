                   ...
                   <div class="bg-white mb-4" style="border:solid 1px #ebebf2;box-shadow:1px 2px 4px 0 rgba(94, 94, 94, 1);">  
                       ...
                       <div class="row">
                        ...
                        <!---->
                             ...
                             <div class="row">
                           <div class="col-4">
                                <p class="text-right paytext">Training</p>
                           </div>
                           <div class="col-8">
                               <p class="text-left paytexxt">{{ $training_plan->training_package->package_name }}</p>
                           </div>
                       </div>
                         ...
                         <div class="row">
                           <div class="col-4">
                                <p class="text-right paytext">Balance</p>
                           </div>
                           <div class="col-8">
                               <p class="text-left paytexxt">${{ number_format($total - $amount_paid, 2) }}</p>
                           </div>
                       </div>                       
                            <!---->
                            <!-- <div class="row">
                           <div class="col-4">
                                <p class="text-right paytext">Payment type</p>
                           </div>
                           <div class="col-8">
                               <p class="text-left paytexxt">Installmental payment</p>
                           </div>
                       </div> -->
